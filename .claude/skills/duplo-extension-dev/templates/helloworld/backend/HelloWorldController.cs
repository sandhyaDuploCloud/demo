...
public class HelloWorldController : ResourcesController<HelloWorld, HelloWorldSpec, HelloWorldResult>
{
    public HelloWorldController(IEntityService<HelloWorld> service, ILogger<HelloWorldController> logger)
        : base(service, logger)
    {
    }
}
